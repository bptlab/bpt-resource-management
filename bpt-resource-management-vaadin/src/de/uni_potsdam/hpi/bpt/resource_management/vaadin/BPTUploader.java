		...
		finishUploadButton.addListener(new Button.ClickListener(){
			public void buttonClick(ClickEvent event) {
				...
				toolRepository.createDocument("BPTTool", generateDocument(new Object[] {
					...
					new HashSet<String>(availabilitiesTagComponent.getTagValues()),
					new HashSet<String>(modelTagComponent.getTagValues()),
					new HashSet<String>(platformTagComponent.getTagValues()),
					new HashSet<String>(functionalityTagComponent.getTagValues()),
					"Random name",
