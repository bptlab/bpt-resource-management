...
//	}
	 ...
	 */
	public int getNumberOfEntries(String setId, String language, String fullTextSearchString) {
		String queryString = buildQueryString(setId, language, fullTextSearchString);
...
//	 */
//	public ArrayList<Map> search(String setId, String language, String fullTextSearchString, 
//			int skip, int limit, 
...
//	}
	...
	private String buildQueryString(String setId, String language, String fullTextSearchString) {
	...
	@FullText({
	    @Index(
	        ...
	        index = "function(doc) { " +
	                    ...
	                    "res.add(doc.exercise_url); " + 
	                    "res.add(doc.contact_name); " +
	                    "res.add(doc.set_id, {\"field\": \"set_id\"});" + 
